...
<div class="container-fluid content-main">
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="<?php echo \yii\helpers\Url::toRoute('user/update-driver') ?>" class="form-horizontal"
                  method="post">
                ...
                <div class="form-group  <?php echo array_key_exists('username', $errors) ? 'has-error' : '' ?>">
                    ...
                    <div class="col-sm-8">
                        <div class="form-control-static"><?= \yii\bootstrap\Html::encode($user->username) ?></div>
                    </div>
