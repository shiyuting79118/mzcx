<div class="page-title">等级管理</div>

<div class="content-top">
    <ul class="top-nav">
        <li class="active"><span>修改等级</span></li>
...
<div class="container-fluid content-main">
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="<?php echo \yii\helpers\Url::toRoute(['grade/update','$id'=>$id])?>" class="form-horizontal"
                  method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input name="flag_fall" type="text" class="form-control" id="inputEmail"
                               value="<?= \yii\bootstrap\Html::encode($grade->flag_fall) ?>" placeholder="起步价">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="km_price" class="form-control" id="inputPassword3"
                               value="<?= \yii\bootstrap\Html::encode($grade->km_price) ?>" placeholder="每公里单价">
                    </div>
                </div>
